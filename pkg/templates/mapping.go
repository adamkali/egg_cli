...
func Mapping(config *configuration.Configuration) map[string]*template.Template {
	return map[string]*template.Template{
		...
		"./models/responses/string_response.go":                         template.Must(template.New("./models/responses/string_response.go").Parse(MODELS_RESPONSE_StringResponseTemplate)),
		...
		"./" + config.Database.QueriesLocation + "/user.sql":            template.Must(template.New("./" + config.Database.QueriesLocation + "/user.sql").Parse(DATABASE_QUERIES_UserTemplate)),
		"./" + config.Database.Migration.Destination + "/0001_init.sql": template.Must(template.New("./" + config.Database.Migration.Destination + "/migrations/0001_init.sql").Parse(DATABASE_MIGRATIONS_INITTemplate)),
		"./" + config.Database.QueriesLocation + "/token.sql":           template.Must(template.New("./" + config.Database.QueriesLocation + "/token.sql").Parse(DATABASE_QUERIES_TokenTemplate)),
	}
}
